...
## 1. 기획 배경 
* **기존 문제점:** 매주 릴리즈 시 수십 개의 티켓 상태(Jira)와 실제 코드 반영 여부(GitLab)를 일일이 수동으로 대조해야 했습니다.
...
* **커뮤니케이션 비용 감소:** 개발팀에게 일일이 물어볼 필요 없이 대시보드 링크 하나로 현황을 실시간 파악하고 즉각적인 Action Item 도출 가능.
